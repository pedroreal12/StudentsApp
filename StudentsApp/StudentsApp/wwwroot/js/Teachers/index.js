...
function buildTable(data, currentPage = 1) {
    ...
    for (index = startIndex; index < endIndex; index++) {
        ...
        tableHTML += "<td><a href='Teachers/Details/" + dataObj.Id + "'>Details</a></td>";
        tableHTML += "<td><a href='Teachers/Edit/" + dataObj.Id + "'>Edit</a></td>";
        tableHTML += "<td><a href='Teachers/Delete/" + dataObj.Id + "'>Delete</a></td>";
        tableHTML += "</tr>";
    }
